...
if (headline && headline.text) {
  ...
  if (viewAllButton) {
    ...
    const btnInst = initSanityButton(btnWrap, { button: viewAllButton });
    childInstances.push(btnInst);
  }
...
if (headline && headline.text) {
  ...
  if (viewAllButton) {
    ...
    const mBtnInst = initSanityButton(mobileBtnWrap, { button: viewAllButton });
    childInstances.push(mBtnInst);
  }
