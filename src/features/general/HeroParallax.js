...
import { initAnimatedHeadline } from './initAnimatedHeadline.js';
import { initAnimatedSubtext } from './initAnimatedSubtext.js';
import { initButtonGroup } from './utils/ButtonGroup.js';
import { createImageElement } from '../assets/medias/shared/imageElement.js'; 
import { usePageEnter } from '../hooks/usePageEnter.js'; 
import { usePageEnterContext } from '../hooks/usePageEnterContext.js'; 
import { initSanityMedia } from '../assets/medias/SanityMedia.js'; 
import { HIGH_RES_SOURCE_WIDTHS } from '../assets/medias/shared/mediaConstants.js'; 
import { getImageSrc, getImageSrcSet } from '../assets/medias/shared/sanityImageUtils.js'; 
import { initGoodFellaWatermark } from './utils/GoodFellaWatermark.js'; 
...
export function initHeroParallax({
  ...
  function destroy() {
    for (const st of scrollTriggerInstances) st?.kill?.();
