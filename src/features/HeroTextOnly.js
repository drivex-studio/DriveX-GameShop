import { usePageEnterContext as getPageEnterContext } from '../hooks/usePageEnterContext.js';

import { usePageEnter as watchPageEnter } from '../hooks/usePageEnter.js';
...
export function initHeroTextOnly(parentElement, props = {}) {
  ...
  // (converted from React hook: usePageEnterContext)
