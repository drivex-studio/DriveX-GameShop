...
export function createIconElement(props = {}) {
  ...
  svg.setAttribute('class', cx('size-[1em] shrink-0', className));
  applyRestProps(svg, restProps);
  const path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
  path.setAttribute('fill', '#232626');
  path.setAttribute('d', pathData);
  svg.appendChild(path);
  return svg;
}

export function createPlusElement(props = {}) {
